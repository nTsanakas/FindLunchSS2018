...
public class FavoritesRestController {
	...
	public ResponseEntity<Integer> registerFavorite(@ApiParam(name="ResponseEntity", value="test123", required=true)@PathVariable("restaurantId") Integer restaurantId,
